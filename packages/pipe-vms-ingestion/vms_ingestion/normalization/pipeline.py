...
from vms_ingestion.normalization.transforms.write_sink_reported_vessel_info import WriteSinkReportedVesselInfo
...
class NormalizationPipeline:
    def __init__(self, options):
        ...
        self.destination_vessel_info = params.destination_vessel_info
        ...
        if self.destination:
            self.affected_entities.append(Entities.POSITIONS)
        ...
        if self.destination_vessel_info:
            self.affected_entities.append(Entities.VESSEL_INFO)
        ...
        if Entities.VESSEL_INFO in self.affected_entities:
            ...
            (
                ...
                >> PickOutputFields(fields=[f"{field}" for field in self.output_fields_vessel_info])
