...
class TestCalculateMsgId(unittest.TestCase):
    def test_raw_message_id_mandatory_fields(self):
        result = get_raw_message_id(timestamp=datetime.fromisoformat("2020-01-01 20:23:01+00:00"),
                                    lat=-52.546,
                                    lon=-71.947,
    ...
    def test_message_id_mandatory_fields(self):
        ...
        result = get_message_id(timestamp=datetime.fromisoformat("2020-01-01 20:23:01+00:00"),
                                lat=-52.546,
                                lon=-71.947,
                                ssvid="CHL|s:AUSTRAL TRAVELER|c:ABC123",
                                fleet="some_fleet",
